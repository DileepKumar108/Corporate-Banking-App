...
graph TD
    ...
    %% Left Side Branches
    Center ---|1| Syntax[Basic Syntax]
    Center ---|2| Life[Lifecycle of a Program]
    Center ---|3| Types[Data Types]
    Center ---|4| Vars[Variables and Scopes]
    Center ---|5| Cast[Type Casting]

    %% Right Side Branches
    Center ---|6| Str[Strings and Methods]
    Center ---|7| Math[Math Operations]
    Center ---|8| Arr[Arrays]
    Center ---|9| Cond[Conditionals]
